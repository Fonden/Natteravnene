...
namespace NR.Controllers
{
    ...
    public class SIController : Controller
    {
        ...
        public SIController(INRRepository NTRepository)
        {
        ...
        public ActionResult Index()
        {
            ...
            return View(reposetory.GetSIViewModel(CurrentProfile.PersonID));
        }

        public ActionResult Info()
        {
            SiInfoModel Content = new SiInfoModel
            {
                Content = reposetory.GetContent(new Guid("20a8ead6-0a74-e411-bf1a-c485084553de")),
                SeniorInstructors = reposetory.GetSeniorInstructors()
            };

            return View(Content);
        }

        public ActionResult  SIFiles()
        {
