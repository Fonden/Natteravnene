...
namespace NR.Entity
{
    ...
    public class DataContextInitialisationAndMigration<TContext, TConfiguration> : CreateDatabaseIfNotExists<TContext>, IDatabaseInitializer<TContext>
        where TContext : Repository
    ...
    public DataContextInitialisationAndMigration(string connection)
    {
